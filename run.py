...
def hyper_tune_network(dataset_name, epochs, batch_size, batch_epoch_ratio, figure_size, initial_weights, lstm, cnns_arch,
    ...
    exp_params_order = ['cnn_arch','learning_rate','seq_len','use_aug','dropout', 'cnn_train_type'] #'cnn_arch','learning_rate','fix_len','use_aug','dropout', 'optimizer','optimizer',
    #
    ...
    for exp_param in exp_params_order:
        ...
        for param in exp_params_[exp_param]:
            ...
            params_to_train['len_valid'] = get_generators(dataset_name,datasets_videos[dataset_name], datasets_frames, temp_param_data['seq_len'],
...
if apply_hyper:
    ...
    results = []
    cnn_arch, learning_rate,optimizer, cnn_train_type, dropout, use_aug, fix_len = ResNet50, 0.0001, (RMSprop,{}), 'retrain', 0.0, True, 20
...
for dataset_name, dataset_videos in datasets_videos.items():
    ...
    train_gen, validate_gen, test_x, test_y, seq_len, len_train, len_valid = get_generators(dataset_name,dataset_videos, datasets_frames,fix_len,figure_size,
                                                                                            force = force, classes = classes, use_aug= use_aug ,use_crop = True,crop_dark=crop_dark)
